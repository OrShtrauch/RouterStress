...
logger: Logger = logging.getLogger(BRUTE_FORCE)
logger.info("started running brute force attack")
...
def signal_handler(signal_number, frame):
    ...
    running = False
    data_handler.run(data, target=target, port=port)
    logger.info("exiting...")
    sys.exit(0)
    ...
    def do():
        ...
        try:
            ...
            if response:
                ...
                exit_code: int = 0 if response.status_code == 200 else 1
